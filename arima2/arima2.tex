...
\pause 
The likelihood of \code{mod1}, \code{mod2} is -141.2 and -144.3, respectively. The \alert{smaller} model has log-likelihood 3.1 units \alert{higher} than the larger model, which is impossible under proper optimization (could estimate $\hat{\MApar}_2 = 0$).
\end{frame}
