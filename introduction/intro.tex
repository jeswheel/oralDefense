...
\begin{frame}{State Space Models}
  ...
  \begin{itemize}
  \item Let $\bm{Y}_{1}, \ldots, \bm{Y}_{N}$ be random variable representing the observed time series. 
  \item A SSM introduces unobservable states $\bm{X}_1, \ldots, \bm{X}_N$. 
  \end{itemize}
